(function() {
    ...
    (function($, window, document) {
        ...
        Plugin.prototype.init = function() {
            ...
            $.each($(".slidesjs-control", $element).children(),
            function(i) {
                var $slide;
                $slide = $(this);
            ...
            if (this.data.touch) {
                $(".slidesjs-control", $element).on("touchstart",
                function(e) {
                    return _this._touchstart(e);
                });
                $(".slidesjs-control", $element).on("touchmove",
                function(e) {
                    return _this._touchmove(e);
                });
                $(".slidesjs-control", $element).on("touchend",
                function(e) {
            ...
            if (this.options.pagination.active) {
                ...
                $.each(new Array(this.data.total),
                function(i) {
        ...
        Plugin.prototype._slide = function(number) {
            ...
            if (!this.data.animating && number !== this.data.current + 1) {
                ...
                if (this.data.vendorPrefix) {
                    ...
                    return slidesControl.on("transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd",
                    function() {
                        slidesControl[0].style[transform] = "";
                        slidesControl[0].style[duration] = "";
                        slidesControl.children(":eq(" + next + ")").css({
